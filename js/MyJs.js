(function(){
  ...
  var _prefix = (function(temp){
    ...
    return false;
  })(document.createElement(PageSlider));

  var PageSlider = (function(){
    function PageSlider(element, options){
      this.settings = $.extend(true, $.fn.PageSlider.defaults, options||{});
  ...
  $.fn.PageSlider = function(options){
    return this.each(function(){
      var me = $(this),
        instance = me.data("PageSlider");

      if(!instance){
        me.data("PageSlider", (instance = new PageSlider(me, options)));
      }
